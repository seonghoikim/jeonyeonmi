...
import { moveItem, moveInFiltered, hSize, EX_TAG_ORDER, EX_TAG_STYLE, type ExhibitionEntry, type ActivityPhoto } from "../../data";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-10 sm:mb-12 gap-5">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button onClick={onDownloadCv} aria-label={u.cvDownload} className="flex items-center gap-1.5 text-xs border border-border text-muted-foreground px-3 sm:px-4 py-2 hover:border-accent hover:text-accent transition-colors" style={MONO}><Download size={13} /><span className="hidden sm:inline">{u.cvDownload}</span></button>
          </div>
        </div>
