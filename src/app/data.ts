...
export const UI = {
  ko: {
    ...
    portfolioDownload: "포트폴리오 다운로드", portfolioPreparing: "포트폴리오를 준비하고 있습니다…", portfolioError: "포트폴리오를 만들지 못했습니다. 다시 시도해주세요.",
  ...
  en: {
    ...
    portfolioDownload: "Download Portfolio", portfolioPreparing: "Preparing your portfolio…", portfolioError: "Couldn't generate the portfolio. Please try again.",
