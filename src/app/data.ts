...
export const UI = {
  ko: {
    ...
    portfolioDownload: "포트폴리오 다운로드", portfolioPreparing: "포트폴리오를 준비하고 있습니다…", portfolioError: "포트폴리오를 만들지 못했습니다. 다시 시도해주세요.", portfolioReady: "포트폴리오가 준비됐습니다. 다운로드가 시작되지 않았다면 아래 버튼을 눌러주세요.",
  ...
  en: {
    ...
    portfolioDownload: "Download Portfolio", portfolioPreparing: "Preparing your portfolio…", portfolioError: "Couldn't generate the portfolio. Please try again.", portfolioReady: "Your portfolio is ready. If the download didn't start, tap the button below.",
