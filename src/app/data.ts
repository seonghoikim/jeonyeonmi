...
export const UI = {
  ko: {
    ...
    portfolioDownload: "포트폴리오 다운로드", cvPrint: "인쇄 / PDF 저장", portfolioPreparing: "이미지를 불러오는 중…",
  ...
  en: {
    ...
    portfolioDownload: "Download Portfolio", cvPrint: "Print / Save PDF", portfolioPreparing: "Loading images…",
...
/* Portfolio print view: rendered in a portal outside .app-root so it's the only
